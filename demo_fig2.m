% This code aims to reproduce the results corresponding to Fig.2
...
%
% To reproduce Fig.2, we set status=0 where aim is to recover the signal 
% exactly in noiseless setting.
...
%             end
    ...
    saveas(FigHandle,strcat('fig2_rho=',num2str(rho),'.png'));
end
